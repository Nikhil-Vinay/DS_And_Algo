/** topological sort is ordering sort.
 * there could be many order of topological sort.
 * topological sort can be done only in directed and acyclic graph.
 * this code is c++11 specific so compile on c++11 and above compiler */
#include<iostream>
#include<map>
#include<list>
using namespace std;
