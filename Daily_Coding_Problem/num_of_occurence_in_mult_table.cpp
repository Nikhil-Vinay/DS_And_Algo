/********** Find Number Of Occurence Of A Digit In Multiplication Table ************************/
...
/* Solution: All rows and columns are sorted so, this is very good example of 2D matrix binary search. 
 * Start from top-right corner.
 * Time complexity is - O(logn^2) ~ O(logn)
 */
